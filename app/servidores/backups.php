...
if ((isset($_GET["Ex"])) && ($_GET["Ex"] == "Del")) {
    ...
    header("Location: index.php?app=Backups&reg=3");
    }
...
?>
	...
	<?php } ?>
        ...
        <div class="page-header">
          <h1>Backups <small>Mikrotik</small></h1>
        </div>
        
        <div class="row" id="powerwidgets">
          <div class="col-md-12 bootstrap-grid"> 
            
            <a href="index.php?app=Servidores" class="btn btn-info">NOVO BACKUP</a><br><br>
 		  ...
 		  $consultas = $mysqli->query("SELECT * FROM backups");
	      ...
	      <?php if($logado['nivel'] == '1') { ?> 
	      	 <a href="javascript:void(0);" onclick="javascript: if (confirm('Deseja realmente excluir esse registro ?')) { window.location.href='?app=Backups&id=<?php echo base64_encode($campo['id']); ?>&Ex=Del&arq=<?php echo base64_encode($campo['arquivo']); ?>' } else { void('') };" class="btn btn-danger tooltiped" data-toggle="tooltip" data-placement="top" title="Excluir"><i class="entypo-trash"></i></a>
	      <?php } ?>
		      </td>
                    </tr>
