...
?>
		     <tr>
                      ...
                      <td><?php echo $first['service']; ?></td>
                      <td><?php echo $first['caller-id']; ?></td>
                      <td><?php echo $first['address']; ?></td>
                      <td><script type='text/javascript'>
		      $(document).ready(function() {
 	 	      $("#up<?php echo $i; ?>").load("app/uptimeppoe.php?ip=<?php echo base64_encode($mk['ip']); ?>&login=<?php echo base64_encode($mk['login']); ?>&senha=<?php echo base64_encode($mk['senha']); ?>");
                 ...
                 <td><a href="index.php?app=PPP&id=<?php echo $_GET['id']; ?>&user=<?php echo base64_encode($first['.id']); ?>&rmid=Ok" class="btn btn-danger tooltiped" data-toggle="tooltip" data-placement="top" title="Derrubar Usuário"><i class="fa fa-thumbs-down"></i></a>
                         ...
                         <div class="modal-dialog">
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                     <iframe src="ping.php?ip=<?php echo base64_encode($mk['ip']); ?>&login=<?php echo base64_encode($mk['login']); ?>&senha=<?php echo base64_encode($mk['senha']); ?>&ping=<?php echo base64_encode($first['address']); ?>" width="100%" frameborder="0" height="150"></iframe>
