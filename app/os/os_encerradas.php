        ...
        <div class="breadcrumb clearfix">
          <ul>
            ...
            <li class="active">Ordem de Serviços Encerradas</li>
          </ul>
        </div>
	...
	<?php } ?>
        ...
        <div class="page-header">
          <h1>Ordem de Serviços Encerradas</h1>
        </div>
        ...
        <div class="row" id="powerwidgets">
          <div class="col-md-12 bootstrap-grid"> 
            ...
            <div class="powerwidget" id="" data-widget-editbutton="false">
              <header>
                <h2>Gerenciar<small>Ordem de Serviços Encerradas</small></h2>
              </header>
	...
	<li><a href="#" onClick ="$('#table-1').tableExport({type:'pdf',pdfFontSize:'7',escape:'false'});"> <img src='assets/images/pdf.png' width='24px'> PDF</a></li>
	      ...
	      <br>
 		  ...
 		  $consultas = $mysqli->query("SELECT * FROM ordemservicos WHERE empresa = '$idempresa' AND encerrado = 'S' order by id DESC");
