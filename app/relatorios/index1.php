                          ...
                          <table class="table ">
                              ...
                              if($_POST['post'] == 1){
                                  ...
                                  if($total == 1){
                                      ...
                                      $consultas = $mysqli->query("SELECT * FROM financeiro WHERE vencimento = '$datainicial' group by boleto");
                                  }else{
                                  $datainicial  = $campo[0];
                                  $datainicial  = substr($datainicial,6,4)."-".substr($datainicial,3,2)."-".substr($datainicial,0,2);
                                  ...
                                  $consultas = $mysqli->query("SELECT * FROM financeiro WHERE vencimento = '$datainicial'  AND situacao = '$campo[1]$campo[2]$campo[3]' group by boleto");
                                  }
...
/*							  $_POST['start'];
							  ...
							  $datai = date('Y-m-d',strtotime($_POST['start']));
							  $dataf = date('Y-m-d',strtotime($_POST['finish']));

							  SELECT * FROM data BETWEEN data = '$datai' AND data = '$dataf'*/
