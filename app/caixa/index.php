...
<table cellpadding="1" cellspacing="10"  width="100%" align="center" style="background-color:#033">
...
R$<input type="text" name="valor" size="8" onKeyUp="moeda(this);" maxlength="10" />
...
<?php }?>
            ...
            <b>Valor:</b> R$<input type="text" value="<?php echo $row['valor']?>" onKeyUp="moeda(this);" name="valor" size="8" maxlength="10" />
            <br/>
