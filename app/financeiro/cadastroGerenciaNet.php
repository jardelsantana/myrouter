        ...
        <div class="powerwidget orange" id="most-form-elements" data-widget-editbutton="false">
                ...
                <form action="" method="POST" class="orb-form">
                  <fieldset>
                    ...
                    <section class="col col-2">
                      ...
                      <label class="input">
                        <input type="text" name="vencimento"  readonly value="<?php echo @$campo['dia']; ?>/<?php echo @$campo['mes']; ?>/<?php echo @$campo['ano']; ?>" required>
                      </label>
                    </section>
		      ...
		      $valorboleto = number_format($campo['valor'],2,'.','');
		       ...
		       ?> 
                  ...
                  <input type="text" name="valor" readonly onKeyUp="moeda(this);" value="<?php echo @$valorboleto; ?>" required>
                      </label>
                    </section>
