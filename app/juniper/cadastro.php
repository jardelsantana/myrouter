<?php 
    ...
    */
    ...
    $crud->inserir("empresa,servidor,ip,login,senha,secret,tipo,lat,lng,interface,tiporouter", "'$empresa','$servidor','$ip','$login','$senha','$secret','$tipo','$lat','$lng','$interface','JUNIPER'");
    ...
    header("Location: index.php?app=BRASJUNOS&reg=1");
    }
    ...
    $crud->atualizar("servidor='$servidor',ip='$ip',login='$login',senha='$senha',secret='$secret',tipo='$tipo',lat='$lat',lng='$lng',interface='$interface'", "id='$servidorid'");
    ...
    header("Location: index.php?app=BRASJUNOS&reg=2");
    }
    ...
    // Fim Radius
    header("Location: index.php?app=BRASJUNOS&reg=3");
    }
...
?>
        ...
        <div class="powerwidget green" id="most-form-elements" data-widget-editbutton="false">
              <header>
                <h2>Cadastro<small>BRAS - JUNIPER</small></h2>
              </header>
                  ...
                  <fieldset>
                    ...
                    <section style="width:180px;">
                      ...
                      <label class="input"> <i class="icon-append fa fa-question"></i>
                        ...
                        <b class="tooltip tooltip-top-right">IP da loopback do BRAS</b> </label>
                    </section>
                    ...
                    <section style="width:180px;">
                      ...
                      <section style="width:210px;">
                          ...
                          <label class="input"> <i class="icon-append fa fa-question"></i>
                              ...
                              <b class="tooltip tooltip-top-right">Senha Secret do Radius, configurado no JUNIPER</b> </label>
                      </section>
                      ...
                      <div class="row">
                        <div class="col col-2">
                          <label class="radio">
                              ...
                              <label class="radio">
                                  <input type="radio" name="tipo" value="25" <?php if(@$campo[tipo] == "25"){ echo  "checked";}?>>
                                  <i></i><img style="height:60px;" src="assets/images/antenas/edgerouterx.png"></label>

                              <label class="radio">
                                  <input type="radio" name="tipo" value="26" <?php if(@$campo[tipo] == "26"){ echo  "checked";}?>>
                                  <i></i><img style="height:60px;" src="assets/images/antenas/edgeroutelite.png"></label>

                              <label class="radio">
                                  <input type="radio" name="tipo" value="27" <?php if(@$campo[tipo] == "27"){ echo  "checked";}?>>
                                  <i></i><img style="height:60px;" src="assets/images/antenas/edgeroutepro.png"></label>

                              <label class="radio">
                                  <input type="radio" name="tipo" value="28" <?php if(@$campo[tipo] == "28"){ echo  "checked";}?>>
                                  <i></i><img style="height:32px;" src="assets/images/antenas/juniper5.jpg"></label>

                              <label class="radio">
                                  <input type="radio" name="tipo" value="29" <?php if(@$campo[tipo] == "29"){ echo  "checked";}?>>
                                  <i></i><img style="height:32px;" src="assets/images/antenas/juniper104.jpg"></label>

                              <label class="radio">
                                  <input type="radio" name="tipo" value="30" <?php if(@$campo[tipo] == "30"){ echo  "checked";}?>>
                                  <i></i><img style="height:32px;" src="assets/images/antenas/juniper204.jpg"></label>
                    ...
                    <section style="width:220px;">
                     ...
                     <section style="width:180px;">
                      ...
                      <label class="input"> <i class="icon-append fa fa-question"></i>
                          <input type="text" name="interface" value="<?php if (@$campo['id'] <> '') { ?><?php echo @$campo['interface']; ?><?php } else { ?><?php echo "ge-1/0/0"; ?><?php } ?>"  placeholder="ge-1/0/0" required>
