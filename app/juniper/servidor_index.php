...
?>
	...
	<div class="alert alert-info alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
	<i class="fa fa-times-circle"></i></button>
        <strong>Atenção!</strong> Backup do JUNIPER realizado com sucesso. </div>
	<?php } ?>
	...
	<?php } ?>
        ...
        <div class="page-header">
          <h1>Servidores<small>BRAS - Juniper</small></h1>
        </div>
        
        <a href="?app=CadastroJuniper" class="btn btn-info">NOVO SERVIDOR</a>
        <br><br>
        ...
        <div class="row" id="powerwidgets">
          <div class="col-md-12 bootstrap-grid"> 
            ...
            <div class="powerwidget" id="" data-widget-editbutton="false">
              <header>
                <h2>Gerenciar<small>BRAS - Juniper</small></h2>
              </header>
	...
	<li><a href="#" onClick ="$('#table-1').tableExport({type:'pdf',pdfFontSize:'7',escape:'false'});"> <img src='assets/images/pdf.png' width='24px'> PDF</a></li>
		  ...
		  ini_set("track_errors","0");
 		  ...
 		  $consultas = $mysqli->query("SELECT * FROM servidores WHERE tiporouter = 'JUNIPER' AND empresa = '$idempresa'");
...
/*    		  // NOVA API
    ...
    <?php if($campo['tipo'] == '28') { ?><img style="height:60px;" src="assets/images/antenas/juniper5.jpg"><?php } ?>
    <?php if($campo['tipo'] == '29') { ?><img style="height:60px;" src="assets/images/antenas/juniper104.jpg"><?php } ?>
    <?php if($campo['tipo'] == '30') { ?><img style="height:60px;" src="assets/images/antenas/juniper204.jpg"><?php } ?>
		     </td>
	...
	<?php if($campo['tipo'] == '26') { ?><img style="height:60px;" src="assets/images/antenas/edgeroutelite.png"><?php } ?>
	<?php if($campo['tipo'] == '27') { ?><img style="height:60px;" src="assets/images/antenas/edgeroutepro.png"><?php } ?>
    <?php if($campo['tipo'] == '28') { ?><img style="height:32px;" src="assets/images/antenas/juniper5.jpg"><?php } ?>
    <?php if($campo['tipo'] == '29') { ?><img style="height:32px;" src="assets/images/antenas/juniper104.jpg"><?php } ?>
    <?php if($campo['tipo'] == '30') { ?><img style="height:32px;" src="assets/images/antenas/juniper204.jpg"><?php } ?>
		     </td>
	      ...
	      <a href="?app=CadastroJuniper&id=<?php echo base64_encode($campo['id']); ?>" class="btn btn-info tooltiped" data-toggle="tooltip" data-placement="top" title="Configurar"><i class="entypo-tools"></i></a>&nbsp;
	      
	      <a href="javascript:void(0);" onclick="javascript: if (confirm('Deseja realmente excluir esse registro ?')) { window.location.href='?app=CadastroJuniper&id=<?php echo base64_encode($campo['id']); ?>&Ex=Del' } else { void('') };" class="btn btn-danger tooltiped" data-toggle="tooltip" data-placement="top" title="Excluir"><i class="entypo-trash"></i></a>
