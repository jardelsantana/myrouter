...
//$confirmacao = mysql_query("SELECT * FROM usuarios WHERE login = '$login' AND senha = '$senha' AND status = 'S'", $db);
$confirmacao = $mysqli->query("SELECT * FROM tecnicos WHERE login = '$login' AND senha = '$senha' AND status = 'S'");
  ...
  <div class="center-block">
    <div class="login-block">
      ...
      <input type="hidden" value="login" name="operacao">
        <header>
          <div class="image-block"><img src="../assets/images/logo.png" alt="ERPMK" /></div>
