...
#instr_header {
	background: url('assets/images/<?php echo $empresa['foto'];?>') no-repeat top left;
	padding-left: 160px;
	height: 56px;
	width: 178px;
...
<!--
 ...
 -->
	...
	<div id="boleto">
		...
		<tr class="campos">
			<td class="cedente"><?php echo utf8_encode($dadosboleto["cedente"]); ?>&nbsp;</td>
		...
		<tr class="campos">
			<td class="sacado"><?php echo utf8_encode($dadosboleto["sacado"])?></td>
		</tr>
		</tbody>
		</table>
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="campos">
				<td class="instrucoes" rowspan="5">
					<p><?php echo utf8_encode($dadosboleto["demonstrativo1"]); ?></p>
					<p><?php echo utf8_encode($dadosboleto["demonstrativo2"]); ?></p>
					<p><?php echo utf8_encode($dadosboleto["demonstrativo3"]); ?></p>
					<p><?php echo utf8_encode($dadosboleto["instrucoes1"]); ?></p>
					<p><?php echo utf8_encode($dadosboleto["instrucoes2"]); ?></p>
					<p><?php echo utf8_encode($dadosboleto["instrucoes3"]); ?></p>
					<p><?php echo utf8_encode($dadosboleto["instrucoes4"]); ?></p>
				</td>
			</tr>
			</tbody>
			</table>
		...
		<tr class="campos">
			<td class="sacado2">
				<p><?php echo utf8_encode($dadosboleto["sacado"]); ?></p>
				<p><?php echo utf8_encode($dadosboleto["endereco1"]); ?></p>
				<p><?php echo utf8_encode($dadosboleto["endereco2"]); ?></p>
			</td>
		</tr>
		</tbody>
		</table>		
